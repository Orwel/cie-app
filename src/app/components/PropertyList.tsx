      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Consulta el precio y la disponibilidad de las propiedades directamente en Airbnb. Si estás interesado puedes hacer la reserva directamente en Airbnb o contactarnos por WhatsApp. Únicamente se arrienda mediante Airbnb para estadías mínimas de un mes.
          </p>
        </div>
